...
export default function ContactSection() {
  ...
  return (
    ...
    >
          ...
          <div className={`rv ${vis ? "on" : ""} d2 contact__form-wrap`}>
            ...
            {status === "success" ? (
              ...
              <div className="contact__success" role="alert" aria-live="polite">
                ...
                <div className="contact__success-countdown" aria-label="Form will reset in 3 seconds">
                  <div className="contact__success-countdown-bar" />
                </div>
              </div>
            ) : (
              <>
      ...
      <style>{`
        .contact__success-icon-wrap {
          position: relative;
          width: 64px; height: 64px;
          display: flex; align-items: center; justify-content: center;
          margin: 0 auto 18px;
        }
        .contact__success-ring {
          position: absolute; inset: 0; border-radius: 50%;
          background: var(--green);
          box-shadow: 0 0 0 8px rgba(48,83,74,.1), 0 10px 28px rgba(48,83,74,.28);
        ...
        .contact__success-icon { position: relative; z-index: 1; }

        .contact__success-countdown {
          width: 100%; max-width: 200px;
          height: 4px; background: rgba(48,83,74,.1);
          border-radius: 2px; overflow: hidden;
          margin: 16px auto 0;
        }
        .contact__success-countdown-bar {
          height: 100%;
